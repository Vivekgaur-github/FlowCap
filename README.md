...
Description
This endpoint is used for user registration. It validates the input data using express-validator and, upon successful validation, creates a new user and returns an authentication token.
...
Description
This endpoint is used for user login. It validates the input data using express-validator and, upon successful validation, authenticates the user and returns an authentication token.
...
Description
This endpoint is used for captain registration. It validates the input data using express-validator and, upon successful validation, creates a new captain and returns the captain's details.
...
Description
This endpoint is used for captain login. It validates the input data using express-validator and, upon successful validation, authenticates the captain and returns an authentication token.
